...
.usage-filters{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin:12px 0}.usage-filter-field{display:inline-flex;align-items:center;gap:6px;margin:0;font-size:12px;color:var(--ink-2);font-weight:650}.usage-filter-field span{display:inline;margin:0;font-size:12px;color:var(--ink-2);font-weight:650;text-transform:none;letter-spacing:0}.usage-filters select{width:auto;min-width:140px;min-height:34px;border:1px solid var(--line-2);background:#fff;border-radius:8px;padding:6px 9px;color:var(--ink);cursor:pointer}.usage-filters .btn{height:34px;min-height:34px;padding:0 12px;font-size:13px}.usage-filters.is-loading{opacity:.6;pointer-events:none}
...
@media(max-width:900px){.usage-filter-field{width:100%%}.usage-filter-field select{width:100%%}}
</style>
</head>
<body class="%s">
<div class="shell">
