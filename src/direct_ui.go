...
<div class="shell">
<aside class="sidebar">
<div class="brand"><h1>Any2Api Bridge</h1><div class="muted">Direct provider console</div></div>
...
<main class="content">
<div class="top"><div><h2 id="page-title">Direct accounts</h2><div class="muted">Operational console for original CPA providers. Secrets stay write-only; this page only shows configured state.</div></div><span class="pill">%s</span></div>
